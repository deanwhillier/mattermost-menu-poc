...
import {MenuContext, mobileBreakpoint, desktopBreakpoint} from '../menu';
...
export const MenuPanelContext = React.createContext<MenuPanelContextType>({});
...
const MenuPanelComponent: React.FC<Props> = (props) => {
    ...
    const {menuPanelInitialized, menuPanelClosed} = useContext(MenuContext);
